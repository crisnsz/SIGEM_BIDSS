...
$(document).on("click", "#_ModalApprove", function () {
    SendData(_idPrimary = "Lianvi_Id", _controller = "LiquidacionAnticipoViatico", _action = "ApprovePorJefe", _spinnerbody = "spinner-body", _spinner = "spinnerd");
});

$(document).on("click", "#_ModalApproveRRHH", function () {
    SendData(_idPrimary = "Lianvi_Id", _controller = "LiquidacionAnticipoViatico", _action = "ApprovePorRRHH", _spinnerbody = "spinner-body", _spinner = "spinnerd");
});


$(document).on("click", "#_ModalApproveAdmin", function () {
    SendData(_idPrimary = "Lianvi_Id", _controller = "LiquidacionAnticipoViatico", _action = "ApprovePorAdmin", _spinnerbody = "spinner-body", _spinner = "spinnerd");
});
...
$(document).on("click", "#_ModalReject", function () {
    ...
    if (_spanRR.value == "" || _spanRR.value == null) {
        ...
        SendData(_idPrimary = "Lianvi_Id", _controller = "LiquidacionAnticipoViatico", _action = "Reject", _spinnerbody = "spinner-body-reject", _spinner = "spinnerd-reject");
    }
});
