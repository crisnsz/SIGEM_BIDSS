...
$(document).on("click", "#_ModalApprove", function () {
    SendData(_idPrimary = "Acp_Id", _controller = "AccionPersonal", _action = "ApprovePorJefe", _spinnerbody = "spinner-body", _spinner = "spinnerd");
});

$(document).on("click", "#_ModalApproveRRHH", function () {
    SendData(_idPrimary = "Acp_Id", _controller = "AccionPersonal", _action = "ApprovePorRRHH", _spinnerbody = "spinner-body", _spinner = "spinnerd");
});


$(document).on("click", "#_ModalApproveAdmin", function () {
    SendData(_idPrimary = "Acp_Id", _controller = "AccionPersonal", _action = "ApprovePorAdmin", _spinnerbody = "spinner-body", _spinner = "spinnerd");
});
